...
/** 用户成长等级：按近 30 天 tokens 计算，0 → 15B 分 10 级，15B+ 满级 */
...
export const GROWTH_LEVELS: GrowthLevel[] = [
  ...
  { level: 2, name: '探索', threshold: 1_000_000, color: '#4f8cff' },
  { level: 3, name: '实践', threshold: 5_000_000, color: '#38bdf8' },
  { level: 4, name: '熟练', threshold: 20_000_000, color: '#22d3ee' },
  { level: 5, name: '精通', threshold: 80_000_000, color: '#2dd4bf' },
  { level: 6, name: '专家', threshold: 250_000_000, color: '#34d399' },
  { level: 7, name: '大师', threshold: 800_000_000, color: '#a3e635' },
  { level: 8, name: '宗师', threshold: 2_000_000_000, color: '#fbbf24' },
  { level: 9, name: '传奇', threshold: 5_000_000_000, color: '#f472b6' },
  { level: 10, name: '王者', threshold: 15_000_000_000, color: '#f59e0b' },
]
